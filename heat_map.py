...
def parse_option():
    ...
    parser.add_argument('--imgname', help='tag of experiment')
...
if __name__ == "__main__":
    ...
    grayscale_cam = cam(input_tensor=input_tensor,
                        targets=[ClassifierOutputTarget(class_id)])  # [ClassifierOutputTarget(class_id)]
    grayscale_cam = grayscale_cam[0, :]

    # 可视化
    visualization = show_cam_on_image(rgb_img, grayscale_cam, use_rgb=True)
    # cv2.imwrite('dataset/sp9/heatmap.jpg',visualization)
