...
#             --ckp_path pridictpath/0926-ep457-rbg-92.93.pth --img_path dataset/pd2/'
#
# os.system(cmd4)
#
# cmd4 = 'python pridiction.py  --cfg configs/swinv2/swinv2_base_patch4_window16_256.yaml   \
#             --ckp_path pridictpath/1029-ep128-rgb-82-.pth --img_path dataset/pd2/'
#
# os.system(cmd4)

# heat_map = 'python heat_map.py --cfg configs/swinv2/swinv2_tiny_patch4_window16_256-512.yaml --data-path dataset/11/test4.jpg --pretrained pridictpath/1021-ep141-gry-86.69.pth --local_rank 0 '
# os.system(heat_map)
